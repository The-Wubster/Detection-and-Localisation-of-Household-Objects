...
def run(
    ...
    if (verbose or (nc < 50 and not training)) and nc > 1 and len(stats):
        ...
        metric_df.to_csv(current_dir + '/Run_metrics/' + "metrics-"+ "Yolo-"+ str(weights) + '-' + str(imgsz) + '-' + 'Custom Semitrained-' + 'Validation-' + str(iou_thres) + '-' + str(conf_thres)  + "-.csv", index=False)
